...
# Set EGL platform for offscreen rendering before any OpenGL imports
os.environ["PYOPENGL_PLATFORM"] = "egl"
# Disable cuDNN globally for RTX 5090 compatibility
os.environ.setdefault("PYTORCH_CUDNN_V8_API_ENABLED", "0")
import sys
import torch
# Disable cuDNN at PyTorch level for RTX 5090 compatibility
...
def main(hydra_cfg):
    ...
    for i in range(n_manip_tasks):
        ...
        try:
            ...
            print(f"[warning] Skipping task {i} due to dataset loading failure")
            continue
        print(os.path.join(cfg.folder, benchmark.get_task_demonstration(i)))
