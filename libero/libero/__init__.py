import os
# Set EGL platform for offscreen rendering before any OpenGL/robosuite imports
# This must be set before importing any module that uses OpenGL
os.environ.setdefault("PYOPENGL_PLATFORM", "egl")
# Import OpenGL initialization module to force platform setup
try:
    from . import _opengl_init
except ImportError:
    pass
import yaml
